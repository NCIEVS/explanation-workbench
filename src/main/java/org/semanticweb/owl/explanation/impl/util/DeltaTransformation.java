...
//            }
        ...
        public Set<OWLAxiom> visit(OWLEquivalentObjectPropertiesAxiom axiom) {
            return visit((Set<? extends OWLAxiom>) axiom.asSubObjectPropertyOfAxioms());
        }
        ...
        public Set<OWLAxiom> visit(OWLEquivalentDataPropertiesAxiom axiom) {
            return visit((Set<? extends OWLAxiom>) axiom.asSubDataPropertyOfAxioms());
        }
        ...
        public Set<OWLAxiom> visit(OWLEquivalentClassesAxiom axiom) {
            return visit((Set<? extends OWLAxiom>) axiom.asOWLSubClassOfAxioms());
        }
