...
//            System.out.println(result );
    ...
    private void computeCandidateRoots() throws ExplanationException {
        ...
        for (OWLClass cls : unsatisfiableClasses) {
            checker.reset();
            EntitySearcher.getSuperClasses(cls, reasoner.getRootOntology()).forEach(sup -> sup.accept(checker));
            
            EntitySearcher.getEquivalentClasses(cls, reasoner.getRootOntology()).forEach(eqv -> eqv.accept(checker));
